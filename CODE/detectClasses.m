...
backgroundMask      = backgroundMask1+ismember(backgroundMask_L,find([backgroundMask_LP.Area]<(rows*cols*1e-3)));
...
imagesc(innerWhite3*2+H_E_chromatic_highSat.*(data_hsv(:,:,1)>0.55).*(data_hsv(:,:,1)<0.78))
