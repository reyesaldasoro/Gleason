...
saveDir                     = 'C:\Users\sbbk034\OneDrive - City, University of London\Documents\GitHub\Gleason\DataTest2D\';
...
for k=1:128
    ...
    if((currentTest(1).Width/10)~=cols)|((currentTest(1).Height/10)~=rows)
        ...
        dataOut             = interp2(Y1,X1,double(currentImage),Y,X);
%         figure(1)
%         imagesc(currentImage)
%         figure(2)
%         imagesc(b)
%       imwrite(b,currentImageName);
    else
        dataOut             = currentImage;
